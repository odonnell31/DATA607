...
url_full <- paste0('https://www.indeed.com/jobs?q=Data+Scientist&l=united+states&start=1')
cat(url_full)
```
```{r}
...
page_seq <- paste0("https://www.indeed.com/jobs?q=Data+Scientist&l=united+states&start=", seq(1, 60, 10 ))
